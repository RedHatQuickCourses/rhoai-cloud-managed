...
[WARNING]
This page has not been updated, its just clone of GUI installation at the moment


Instructions for creating a Red Hat OpenShift AI environment that is capable of running multiple LLMs, pipelines, Model Serving and performing just about every task that is possible with OpenShift AI. 
